...
MATCHES = {
    ...
    '<strong>They are used by type checkers like <a href="https://pypi.org/project/mypy/">mypy</a> and <a href="https://pypi.org/project/pydantic/">Pydantic</a>, however they are not enforced by CPython interpreter. To annotate a function use <code class="python hljs"><span class="hljs-string">\'def f(a: int = 0) -&gt; int: ...\'</span></code>.</strong>': '<strong>They are used by type checkers like mypy and Pydantic, however they are not enforced by CPython interpreter. To annotate a function use <code class="python hljs"><span class="hljs-string">\'def f(a: int = 0) -&gt; int: ...\'</span></code>.</strong>',
